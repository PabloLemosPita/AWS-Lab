...
Este projeto demonstra como criar um bucket S3 e fazer upload de arquivos locais utilizando Python + Boto3, com foco em ambiente local via LocalStack.
Ele é ideal para testes de pipelines ETL, automações ou aprendizado de serviços AWS sem custos.

O script realiza as seguintes etapas:

-Conecta-se a um endpoint S3 local (http://localhost:4566) usando credenciais fictícias.
-Cria um bucket S3.
-Percorre um diretório local (../data).
